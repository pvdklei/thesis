...
void main() {
	...
	vs.UV = aUV;
	vs.tangentToWorldSpaceQTang= aTangentToModelSpaceQTang; // Model transform not applied
}
...
void main() {
	...
	ppga_rotor tangentToWorld = ppga_qtangent_exp(vs.tangentToWorldSpaceQTang);
